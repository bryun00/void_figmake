  ...
  return (
    <div className="relative shrink-0 w-full" data-name="hero">
      ...
      <div className="[word-break:break-word] content-stretch flex flex-col gap-[16px] items-start not-italic px-[20px] py-[40px] relative size-full text-[#e4501d]">
        ...
        <p className="font-['Pretendard:Regular',sans-serif] leading-[1.6] relative shrink-0 text-[22px] w-full">{`우리는, 고객사와 '함께 고민하고, 함께 쓰는' Web/Creative 파트너입니다.`}</p>
      </div>
    </div>
  );
}
...
function MemberBio() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="member-bio">
      ...
      <p className="font-['Pretendard:Regular',sans-serif] leading-[1.7] not-italic relative shrink-0 text-[#161513] text-[14px] w-full">인간 중심적 가치를 탐구하는 웹 디자이너이자 디렉터입니다. 에이전시 및 스타트업에서의 다양한 경험을 거쳐, 2022년 maithi 스튜디오를 설립하였습니다. 클라이언트의 비전과 철학이 조화를 이루는 최상의 완성도를 지향하며, 구조적으로 아름답고 깊이 있는 웹 경험을 일구어가고 있습니다.</p>
    </div>
  );
}
